...
def count_letters(text):
    ...
    Буквы приводятся к нижнему регистру, учитываются только буквы.
    """
    letter_count = {}
...
letter_counts = count_letters(main_str) # считаем буквф

frequencies = calculate_frequency(letter_counts) # считаем часоты
